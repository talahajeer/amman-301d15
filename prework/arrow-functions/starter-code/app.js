...
//this here refers to the object built "joe".
// 2. What is "this" when joe.scopeArrow() is invoked?
//this here is refering to the window where the arrow function is.
// 3. Explain why "this" is different when an arrow function is used.
//When an arrow function is used, this will refer to the window where the arrow funcrion is declared, in this case is the global window.
